...
// CDMSChartEvents0 wrapper class

class CDMSChartEvents0 : public COleDispatchDriver
{
public:
	CDMSChartEvents0(){} // Calls COleDispatchDriver default constructor
	CDMSChartEvents0(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CDMSChartEvents0(const CDMSChartEvents0& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
