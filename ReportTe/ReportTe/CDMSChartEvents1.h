...
// CDMSChartEvents1 wrapper class

class CDMSChartEvents1 : public COleDispatchDriver
{
public:
	CDMSChartEvents1(){} // Calls COleDispatchDriver default constructor
	CDMSChartEvents1(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CDMSChartEvents1(const CDMSChartEvents1& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
